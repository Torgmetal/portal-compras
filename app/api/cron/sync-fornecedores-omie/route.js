...
export async function GET(req) {
  ...
  try {
    ...
    await registrarExecucao("sync-fornecedores-omie", { ok: true, duracaoMs: Date.now() - t0, mensagem: `total ${r.total} · novos ${r.novos} · vinc ${r.vinculados} · semEmail ${r.semEmail}` });
