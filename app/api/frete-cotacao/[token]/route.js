...
const getLimiter = createRateLimiter({ name: "frete-cotacao-get", maxRequests: 30, windowMs: 60000 });
const postLimiter = createRateLimiter({ name: "frete-cotacao-post", maxRequests: 10, windowMs: 60000 });
