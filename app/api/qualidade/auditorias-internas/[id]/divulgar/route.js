  ...
  const html = `
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;">
      ...
      <div style="background:#f9fafb;padding:24px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;font-size:14px;color:#002945;">
        ${body.mensagem ? `<p style="margin:0 0 14px;white-space:pre-wrap;line-height:1.55;">${textoParaHtml(body.mensagem)}</p>` : `<p style="margin:0 0 14px;line-height:1.55;">Segue em anexo o relatório da auditoria interna realizada no setor <b>${escapeHtml(a.setor)}</b>.</p>`}
