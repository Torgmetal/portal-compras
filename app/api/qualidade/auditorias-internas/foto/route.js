// POST /api/qualidade/auditorias-internas/foto  (multipart: file) → sobe a foto
// da auditoria no Blob e devolve { url }. O front reduz a imagem antes de subir.
...
export async function POST(req) {
  ...
  const blob = await put(`qualidade/auditorias/fotos/foto.${ext}`, buf, { access: "public", addRandomSuffix: true, contentType: tipo });
