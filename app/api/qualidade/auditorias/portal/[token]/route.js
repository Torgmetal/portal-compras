...
export async function GET(_req, { params }) {
  const aud = await prisma.auditoria.findUnique({
    ...
    include: { documentos: { where: { tipo: "EVIDENCIA", publicar: true }, orderBy: { createdAt: "asc" }, select: { id: true, nome: true, secao: true, requisito: true, comentario: true, arquivoTipo: true, arquivoTamanho: true } } },
  });
  ...
  return NextResponse.json({
    ...
    data: {
      ...
      itensAdicionais: aud.itensAdicionais || [],
      equipe,
      totalFuncionarios,
    },
  });
