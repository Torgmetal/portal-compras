...
export async function DELETE(req, { params }) {
  ...
  // a cópia de backup no SharePoint é preservada (controle ISO)
  await prisma.auditLog
    .create({ data: { userId: user.id, action: "EXCLUIR_DOC_QUALIDADE", entity: "DocumentoQualidade", entityId: params.id, diff: { nome: atual.nome, motivo: motivo || null } } })
    .catch(() => {});
