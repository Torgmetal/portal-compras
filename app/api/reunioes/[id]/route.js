...
export async function PATCH(req, { params }) {
  ...
  if (body.atividades !== undefined) {
    ...
    ops.push(prisma.ataAtividade.createMany({ data: body.atividades.map((a, i) => ({ ataId: ata.id, descricao: a.descricao.trim(), op: a.op?.trim() || null, setor: a.setor?.trim() || null, responsavel: a.responsavel?.trim() || null, origemAtaNumero: a.origemAtaNumero ?? null, prazo: a.prazo ? new Date(a.prazo + "T12:00:00Z") : null, ordem: i })) }));
  }
