// PCP › Fila do Jato — o que terminou o setor anterior e ainda não passou por aqui.
//
// ⚠ NÃO CONFUNDIR COM /pcp/jato, que é a Programação (SetorClient: quem ESTÁ no setor, com
...
export const metadata = { title: "Workspace Torg — PCP · Fila do Jato" };
export const dynamic = "force-dynamic";

export default async function PcpFilaJato() {
