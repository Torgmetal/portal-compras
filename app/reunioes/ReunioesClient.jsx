...
import { NotebookPen, Plus, Loader2, AlertCircle, X, Trash2, Users, CheckCircle2, Clock } from "lucide-react";
...
function ModalNovaAta({ onClose, onCriada }) {
  ...
  const [atividades, setAtividades] = useState([{ descricao: "", setor: "", responsavel: "", prazo: "" }]);
    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-start justify-center p-4 overflow-y-auto" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl my-6">
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-torg-dark mb-1.5">Atividades (atribuídas a setores)</label>
            <div className="space-y-2">
              {atividades.map((a, i) => (
