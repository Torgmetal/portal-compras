...
export default function CompetenciasClient() {
  return (
    <div className="space-y-6 max-w-[1400px]">
      <div>
        <h2 className="text-3xl font-extrabold text-torg-dark tracking-tight">Matriz de Competencias</h2>
        <p className="text-sm text-torg-gray mt-1">Competencias por cargo e avaliacao de funcionarios</p>
      </div>
