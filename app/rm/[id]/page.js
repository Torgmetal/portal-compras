           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
               ...
               <select
                 ...
                 className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
               >
                                   <option valuPage_DownPage_DownePage_Down="">Selecione o fornecedor vencedor...</option>
 {cotacoes.map((c) => (
...
{showPedido && pedidoOmie && (
          <div className="bg-white rounded-xl shadow-sm border-2 border-emerald-200 p-6">
           ...
           <p className="text-sm text-emerald-600 mb-4">
              O JSON abaixo será enviado para a API do Omie. Configure suas credenciais Page_DownPage_Down(App Key e App Secret) para envio automático.
  </p>
