...
import { Activity, ClipboardList, FileText, Package, Factory, Map, PackageSearch, Zap } from "lucide-react";
...
const menu = [
  ...
  { href: "/producao/programacao-corte", label: "Programação de Corte", icon: Zap },
