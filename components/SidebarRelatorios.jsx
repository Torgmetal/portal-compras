...
const menu = [
  { href: "/relatorios", label: "Relatórios de Status", icon: FileBarChart2, exact: true },
];

export default function SidebarRelatorios() {
  const pathname = usePathname();
  return (
    <aside className="w-64 bg-white border-r border-torg-blue-100 flex flex-col h-screen fixed left-0 top-0">
      <SidebarModuleSwitcher moduloAtual="Relatórios" />
