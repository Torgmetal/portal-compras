...
- [Rastreabilidade — o R por peça](torg_rastreio_corrida.md) — o R manda (puxa corrida/cert/NF); FIFO pela entrega mais antiga; só peça CORTADA ganha R; armadilha da chapa sem "ESPESSURA"; **dia** do recebimento conta (diaBRT) e corte provado pela etapa seguinte (`corteInferido`, 24/09)
