...
- [Simulador de carga no portal](torg_simulador_carga_portal.md) — "Simular carga" no romaneio prévio; motor lib/carga em Web Worker; IFC medido no navegador; CargaSimulada com itensHash; **empilha pelo AÇO real** (caibro sobre aço, calço ≤15 cm; nem caixa envolvente, nem topoVazado — 24/09)
