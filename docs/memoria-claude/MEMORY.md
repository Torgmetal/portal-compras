...
- [Relatório de ultrassom (RUS)](torg_relatorio_us.md) — tabela = indicação REPROVADA (15.1) + toda peça ensaiada (sem indicação → linha própria, laudo A); tela grava `marca`/`comprimento`, o PDF traduz
