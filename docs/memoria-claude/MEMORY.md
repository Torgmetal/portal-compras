...
- [⚠ Busca do Graph = HTTP 500 desde 22/09](torg_graph_busca_500.md) — derruba 6 pontos, só o cron do LQC avisa (modal de DESENHOS está morto e ninguém sabe); delta e varredura cega NÃO servem; listar `5.Estudos` por orçamento = 651 chamadas, 33,5 s, 90 LQC
