...
- [⚠ Busca do Graph = HTTP 500 desde 22/09](torg_graph_busca_500.md) — derrubou 6 pontos, só o cron do LQC avisava; desenhos e LQC corrigidos por `lib/sharepoint-arvore.js` (listar, nunca buscar); delta e varredura cega NÃO servem; faltam 4 pontos
