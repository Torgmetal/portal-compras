...
export const ETAPAS = {
  ...
  // ⚠⚠ "ENTREGA" É ANOTAÇÃO DE ENTREGA COMBINADA, NÃO CHEGADA (Matheus, 24/09/2026): *"um dos
  // itens vai chegar 29/09, o restante 15/10"*. Serve para escrever a observação ao lado da data —
  // muitas vezes parcial. Não marca "Chegou" (só MATERIAL_RECEBIDO marca) e não muda a previsão
  // que decide atraso e cobrança; para remarcar, é "Data de entrega (previsão)".
  ENTREGA: { rotulo: "Entrega", previsto: "Entrega prevista", ordem: 3, cor: "sky" },
  MATERIAL_RECEBIDO: { rotulo: "Material recebido", previsto: "Recebimento previsto", ordem: 4, cor: "emerald" },
};
