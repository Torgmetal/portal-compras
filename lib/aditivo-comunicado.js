...
export function montarEmailAditivo({ dados, mensagem = null, userName = null, lembrete = false }) {
  ...
  <div style="font-family:Arial,Helvetica,sans-serif;max-width:640px;margin:0 auto;">
    ...
    <div style="padding:22px 24px;background:#fff;border:1px solid #e2e8f0;border-top:0;border-radius:0 0 12px 12px;">
      ...
      <p style="margin:0 0 6px 0;color:#576D7E;font-size:12px;">O comunicado completo vai em PDF anexo. Detalhes na OP: <a href="${urlBase()}/comercial/${ad.op.id}?vista=obra#aditivo-${ad.numero}" style="color:#006EAB;">${urlBase()}/comercial/${ad.op.id} · aba Obra › Aditivo ${ad.numero}</a></p>
      __ACEITE__
    </div>
  </div>`;
  return { subject, html };
