...
export async function gerarAuditoriaInternaPDF(a) {
  ...
  pages.forEach((p, i) => {
    ...
    p.drawText(san(`${numRAI(a.numero)} · Torg Metal · ${refFORM(31)} · auditoria interna${a.divulgadoEm ? ` · emitido em ${fmtDT(a.divulgadoEm)}` : ""}${a.finalizadoEm ? ` · finalizado em ${fmtDT(a.finalizadoEm)}` : ""} · documento controlado (ISO)`), { x: M, y: 19, size: 7, font, color: GRAY });
