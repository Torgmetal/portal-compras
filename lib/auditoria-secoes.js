...
const MAP_CAT = {
  ...
  FUNCIONARIOS: "Controle de Processo e Fabricação", // qualificação de soldadores
  INSPETORES: "Monitoramento e Medição",
  EQUIPAMENTOS: "Monitoramento e Medição", // calibração
...
export const REQUISITOS_GQFQ003 = [
  ...
  { id: "cqs", secao: "Controle de Processo e Fabricação", label: "Qualificação de soldadores (CQS)" },
  ...
  { id: "inspetores", secao: "Monitoramento e Medição", label: "Qualificação dos inspetores de END" },
  { id: "calibracao", secao: "Monitoramento e Medição", label: "Certificados de calibração + procedimento de controle" },
