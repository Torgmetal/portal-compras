...
// Limite de erro admissível padrão (% do valor nominal) — PO-20 = 20%. Editável por
// equipamento; a norma (ISO 9001 §7.1.5 / ISO 10012) não fixa %, quem define é a Torg.
export const ERRO_MAX_PERCENT_SUGERIDO = 20;
...
export const CRITERIO_ACEITACAO_PADRAO =
  "Aprovado quando o erro de cada ponto (em % do valor nominal), somado à incerteza, for ≤ 20% (PO-20) " +
