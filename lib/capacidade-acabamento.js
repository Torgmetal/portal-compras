...
// ─── O JATO PRECISA DE MAIS QUE A META ─────────────────
//
// ⚠⚠ 300 t/MÊS. Vitor (06/09/2026): "sobre o jato o mesmo caso, tem que atender a meta e na
// realidade até mais, pois alguns itens que são terceirizados as marcas entram para ele fazer".
//
// Ele recebe a entrega inteira MAIS o retorno de terceiro. Medido em 06/09 nas cinco OPs vivas:
// 65 peças e 5.820 kg em TERCEIRIZADO, sobre ~94 t no total — cerca de 6%. Daí 280 × 1,07 ≈ 300.
// O número é uma estimativa em cima de uma amostra pequena; se a proporção de terceirização mudar
// por tipo de obra, é aqui que se ajusta, num lugar só.
//
// ⚠ DUAS BANCADAS. Vitor: "temos dois jatos, o turbina e o manual". A meta é do SETOR; a divisão
// entre as duas é do PCP com o líder, e o quadro reparte pela metade como ponto de partida.
export const META_KG_MES_JATO = 300000;
export const META_KG_DIA_JATO = Math.round(META_KG_MES_JATO / DIAS_UTEIS_MES);

/** Ritmo medido do jato (p75 de 90 dias) — 6.397 kg/dia, contra os 14.286 da meta: fator 2,2. */
export const RITMO_MEDIDO_KG_DIA_JATO = 6397;
