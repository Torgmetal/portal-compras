...
export function madeiraDaUnidade(u, veic) {
  ...
  // escora de travamento: 2 caibros do tamanho do vão até o volume da frente (lib/carga/travamento.js)
  if (u.travamento?.tipo === "escorar") m.caibro += 2 * u.travamento.vao / 1000;
