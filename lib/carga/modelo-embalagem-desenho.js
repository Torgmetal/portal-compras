...
import { CAIXA_MAD, EMB, MEDIDAS, PAC, PAC_GC, PAC_GRADE, larguraDoPacote } from "./premissas";
...
export const REGRAS = {
  ...
  feixe: [
    `Peças alinhadas pelas pontas, camadas travadas com caibro de ${cm(PAC.madeira)} a cada 1,5 m; pacote até ${cm(larguraDoPacote())} de largura (dois lado a lado na carreta) × ${cm(PAC.alturaMax)} de altura.`,
    `Cintas PET a 50 cm das pontas e a cada 1,5 m, com cantoneira de proteção; até ${kg(PAC.kgMax)} por pacote. Sobre caibros, nunca direto no assoalho.`,
    `Perfil viaja com a alma em pé; peça mais pesada embaixo do pacote.`,
  ],
  engradado: [
  ...
  solta: [
    `Sobre 2 caibros 5×6 no mínimo (1 a cada 1,5 m), atravessados e alinhados com os da camada de baixo — também no assoalho: aço nunca direto no piso.`,
    "Conferir o contato e o nivelamento dos apoios; definir os calços conforme a peça, sem deixar vãos.",
