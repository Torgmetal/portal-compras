...
export function recalcularMontagem(carga, madeira=100) {
  ...
  const trav=travamentoDaCarga(itens,{madeira,veiculo:carga.veiculo});for(const u of itens){const t=trav.get(u.id);if(t)u.travamento=t;else delete u.travamento;}
