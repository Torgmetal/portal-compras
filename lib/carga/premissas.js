...
export const PERFIS = {
  economico:   { ...REGRAS, chave: "economico", nome: "Econômico", lqc: "ECONOMICA", resumo: "Pacotes amarrados com cintas e madeira, guarda-corpo deitado em pacote, vigas em feixe cintado, miúdos em caixa de madeira fechada, sem proteção extra de pintura.", gc: "melhor", planos: "pacote", miudos: CAIXA_MAD, protecao: "nenhuma", tempoExtra: 0 },
  recomendado: { ...REGRAS, chave: "recomendado", nome: "Padrão", lqc: "PADRAO", resumo: "Guarda-corpo em pé em engradado quando reduz viagem, vigas em feixe cintado, cantoneira sob toda cinta em peça pintada, miúdos em caixa de madeira fechada.", gc: "melhor2", planos: "pacote", miudos: CAIXA_MAD, protecao: "cantoneiras", tempoExtra: 1 },
