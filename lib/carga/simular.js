...
function saidaDaCarga(c, perfil) {
  ...
  return { versaoMontagem: 6, veiculo: c.veic, grupo: c.grupo, estrategia: c.estrategia, itens, peso: Math.round(c.peso), altura: c.altura, chao, usa, passos, alertas: c.itens.filter((u) => u.alerta).length,
