 ...
 *
 * ⚠ A comparação de texto é pela PRIMEIRA PALAVRA (o substantivo do material): é ela que separa uma
 * chapa de uma porca. Bitola, acabamento e grafia no resto não são troca.
 */
export function ehOutroMaterial(antes, depois, rastro = {}) {
  ...
  if (chave(antes) === chave(depois)) return false;
  // ⚠ Rastreabilidade igual dos dois lados = mesma coisa física. Só conta quando ela EXISTE dos
  // dois lados: dois vazios não provam nada.
