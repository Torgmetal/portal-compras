...
function montarLinha(m, obs, remessa) {
  ...
  return {
    ...
    // ⚠⚠ A DATA DA OBRA INTEIRA, não só desta conferência. Matheus (21/09/2026): "é interessante
    // manter a data que a peça foi conferida nos demais, se ele for mandando parcial, para saber
    // em qual data tal peça foi conferida sem precisar ir nos outros arquivos". É a diferença
    // entre a planilha responder sozinha e obrigar o PCP a abrir as anteriores.
    conferidaEm: m.conferidaEm || null,
  };
}
