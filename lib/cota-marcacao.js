 ...
 *
 * @param {Array<{letra,ax,ay,bx,by,lado}>} cotas `lado` ("topo"/"base" ou "esq"/"dir") força o
 *   lado escolhido à mão; sem ele, o lado sai sozinho da metade da folha onde a cota foi marcada.
