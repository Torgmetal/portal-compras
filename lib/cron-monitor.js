...
export const CRONS_ESPERADOS = [
  // ⚠ 8 dias de folga: roda 1x por semana (domingo 4h). Atrasar aqui significa estar sem cópia
  // do banco fora do Neon — é o alerta mais importante da lista.
  { job: "backup-banco",             label: "Backup do banco (SharePoint)", maxHoras: 192, path: "/api/cron/backup-banco" },
  { job: "estoque-produtos",         label: "Estoque · produtos",          maxHoras: 30,  path: "/api/cron/estoque-produtos" },
  { job: "estoque-movimentacoes",    label: "Estoque · movimentações",     maxHoras: 30,  path: "/api/cron/estoque-movimentacoes" },
  { job: "sync-sharepoint",          label: "SharePoint · planejamento",   maxHoras: 30,  path: "/api/producao/sync-sharepoint" },
  { job: "sync-entregas",            label: "Conciliação de recebimento",  maxHoras: 30,  path: "/api/cron/sync-entregas" },
  { job: "faturamento",              label: "Faturamento (Omie)",          maxHoras: 30,  path: "/api/cron/faturamento" },
  { job: "financeiro",               label: "Financeiro (Omie)",           maxHoras: 30,  path: "/api/cron/financeiro" },
  { job: "qualidade-vencidos",       label: "Qualidade · doc. vencidos",   maxHoras: 200, path: "/api/cron/qualidade-vencidos" }, // semanal (seg)
  { job: "reconciliar-syneco-corte", label: "Baixa do corte (Syneco)",     maxHoras: 30,  path: "/api/cron/reconciliar-syneco-corte" },
  { job: "data-book",                label: "Data Book · volumes",         maxHoras: 2,   path: "/api/cron/data-book" },
  { job: "rnc-abertas",              label: "RNC sem movimento",           maxHoras: 30,  path: "/api/cron/rnc-abertas" },
  { job: "pasta-engenharia",         label: "Pasta da Engenharia",         maxHoras: 6,   path: "/api/cron/pasta-engenharia" }, // de hora em hora, em lotes
  ...
  { job: "cmr-sincronizar",          label: "CMR · recebimento",           maxHoras: 30,  path: "/api/qualidade/cmr/sincronizar" },
  // ⚠ o casamento era manual e acumulou 162 certificados com PDF na pasta e sem vínculo (05/09/2026)
  { job: "casar-certificados",       label: "Certificados · casar PDFs",   maxHoras: 30,  path: "/api/cron/casar-certificados" },
];
