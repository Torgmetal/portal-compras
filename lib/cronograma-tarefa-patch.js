...
function aplicarEstimativa(ctx, entrada, tarefa) {
  ...
  // Revisar os mesmos dias também altera o compromisso e precisa aparecer na auditoria.
  ctx.diffAntes.estimativaEm = tarefa.estimativaEm ?? null;
  ctx.diffDepois.estimativaEm = ctx.data.estimativaEm;
}
