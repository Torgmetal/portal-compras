...
// ⚠ `EM_AVALIACAO` entra pelo mesmo motivo: enquanto o cliente lê o PDF no portal dele, o livro
// não pode mudar por baixo. Se mudasse, ele aprovaria um documento e outro iria para a assinatura.
export const ESTADOS_FECHADOS = new Set(["EMITIDO", "EM_AVALIACAO", "EM_ASSINATURA", "ENVIADO_CLIENTE", "ACEITO"]);
