...
export const GRUPO_POR_SECAO = { "04": "ESTRUTURAL", "05": "FIXADOR", "06": "CONSUMIVEL", "14": "ABRASIVO", "15": "TINTA" };

/** Grupo → seção onde aquele certificado DEVE estar. Inverso de GRUPO_POR_SECAO. */
export const SECAO_POR_GRUPO = { ESTRUTURAL: "04", FIXADOR: "05", CONSUMIVEL: "06", ABRASIVO: "14", TINTA: "15" };
...
export function secaoCertaDoDoc(doc, numeroSecao) {
  const esperado = GRUPO_POR_SECAO[numeroSecao];
  ...
  return grupo === esperado ? null : SECAO_POR_GRUPO[grupo] || null;
}
