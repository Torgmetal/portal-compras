...
// TB/TUBO→Tubo, o resto (W, H, U, L, T…)→Perfil. Usado na §02 do Data Book.
...
// §05 da OP-070 eram lidas como aço estrutural e o portal ia querer movê-las pra §04.
...
export function classificarMaterial(nome) {
  ...
  // padrão e vai parar na §04 junto com o aço.
 ...
 * materiais". Era o caso do "ENDURECEDOR PARA INDUSTHANE 35.010" na §04 da OP-067 — vínculo feito
...
//
// Ele clicou em "Vincular documento" na §02 (Desenhos as-built) e o portal ofereceu certificados
...
//   §02 → "Anexo — Desenhos as-built (fabricação e montagem)"   87 docs
//   §08 → "Anexo — Qualificação dos soldadores"                 40 docs
//   §19 → "Anexo — Certificados de calibração"                  35 docs
//
