...
/**
 * Escapa texto para entrar em HTML de e-mail.
 *
 * ⚠⚠ TODO VALOR DINÂMICO PASSA POR AQUI (achado do Codex, 13/09/2026). O alerta do monitor
 * interpolava a mensagem de erro do cron crua — e essa mensagem carrega conteúdo de fora: nome de
 * arquivo do SharePoint, corpo de resposta do Omie, caminho de pasta. Cru, um `<` num nome de
 * arquivo já quebra a formatação, e conteúdo escolhido de fora poderia forjar o que o e-mail diz.
 */
export const escaparHtml = (v) => String(v ?? "")
