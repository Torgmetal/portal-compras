...
- setor: o setor responsável, um destes quando tiver certeza razoável: ${SETORES_ATA.join(", ")}.
  ...
  Se não der pra determinar o setor com segurança, use null: fica em branco para alguém preencher depois, e um setor chutado manda a atividade para quem não é o dono.
...
export const ESQUEMA_ATIVIDADES = Esquema.objeto({
  atividades: Esquema.lista(Esquema.objeto({
    op: Esquema.textoOuNulo,
    descricao: Esquema.texto,
    setor: Esquema.umDeOuNulo(SETORES_ATA),
