...
- categoria: o que é o documento. Use EXATAMENTE um destes: "TINTA" (a tinta em si), "ENDURECEDOR" (endurecedor/catalisador/componente B vendido à parte) ou "DILUENTE" (diluente/thinner/redutor). Boletim de tinta bicomponente que descreve A e B juntos é "TINTA".
...
- componenteA: o nome/código do componente A (base/resina), como o boletim nomeia. null quando o produto é monocomponente.
- componenteB: o nome/código do componente B (endurecedor/catalisador). null quando é monocomponente.
- proporcaoMistura: a proporção de mistura A:B como está escrita (ex.: "4:1 em volume", "3:1 em peso"). null se não houver.
- potLife: a vida útil da mistura / pot life (ex.: "4 h a 25 °C"). null se não houver.
...
{"produtos":[{"categoria":"TINTA","fabricante":null,"produto":null,"especificacao":null,"componenteA":null,"componenteB":null,"proporcaoMistura":null,"potLife":null,"tipo":null,"norma":null,"diluente":null,"diluicaoMin":null,"diluicaoMax":null,"camadas":[],"secaMin":null,"secaMax":null,"secagemToque":null,"secagemManuseio":null,"secagemRepintura":null,"rendimento":null,"solidos":null,"solidosVol":null,"observacoes":null}]}`;
