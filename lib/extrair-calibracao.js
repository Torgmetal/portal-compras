...
- errosEmPercent: true se as colunas de ERRO e INCERTEZA do certificado JÁ estão em porcentagem (cabeçalhos como "Erro %", "Erro (%)", "Err %", "U %", ou valores marcados com %). false se o erro/incerteza estão em unidade absoluta (mm, °C, A, Ω, V, mV...). MUITO IMPORTANTE: não converta — traga os números exatamente como aparecem; este campo só diz em que unidade eles estão.
...
<json>{"laboratorio":null,"acreditacao":null,"numeroCertificado":null,"dataCalibracao":null,"equipamento":null,"identificacao":null,"unidade":null,"errosEmPercent":false,"faixaMin":null,"faixaMax":null,"empDeclarado":null,"pontos":[],"padroes":[]}</json>`;
