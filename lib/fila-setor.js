...
import { calcularProntidao, CONJUNTO_MONTAVEL, CROQUI_PRONTIDAO_SELECT } from "./prontidao-conjunto";
...
export async function filaDoSetor(setor) {
  ...
  const pecas = await prisma.pecaConjunto.findMany({
    ...
    select: {
      ...
      qteProduzida: true, corteConcluidoEm: true, baixaSetores: true, _count: { select: { conjuntoCroquis: true, croquiConjuntos: true } },
