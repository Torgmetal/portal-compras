...
export const CFOPS = [
  ...
  C("6924", "Remessa interestadual para industrialização por conta e ordem do adquirente", FAMILIA.REMESSA,
    { quando: "O mesmo da 5.924, com o adquirente em outro estado.",
...
export const OPERACOES = [
  ...
  { id: "indust-mp-cliente", titulo: "Industrialização com matéria-prima do cliente", cliente: "QWS",
    ...
    fluxo: ["Fornecedor", "TORG", "Cliente"], cfops: ["5924", "6924", "5925", "6925", "5125", "6125", "5949", "6949"],
    ...
    notas: [
      ...
      { quem: "TORG", cfop: "5925/6925", papel: "Retorno da mercadoria industrializada", de: "TORG", para: "Cliente", obs: "Devolve o que entrou, referenciando a remessa." },
      { quem: "TORG", cfop: "5125/6125", papel: "Industrialização (o que a TORG cobra)", de: "TORG", para: "Cliente", obs: "O valor do serviço e dos materiais que a TORG aplicou." },
    ],
  },
  ...
  { id: "indust-insumo-direto", titulo: "Industrialização com insumos enviados pelo cliente", cliente: null,
    ...
    fluxo: ["Cliente", "TORG", "Cliente"], cfops: ["5901", "6901", "5902", "6902", "5124", "6124"],
    ...
    notas: [
      ...
      { quem: "TORG", cfop: "5902/6902", papel: "Retorno do material aplicado", de: "TORG", para: "Cliente", obs: "O que era do cliente e voltou dentro da peça." },
      { quem: "TORG", cfop: "5124/6124", papel: "Industrialização (o que a TORG cobra)", de: "TORG", para: "Cliente", obs: "O valor agregado pela TORG." },
    ],
  },
  ...
  { id: "indust-entrega-direta", titulo: "Industrialização com entrega ao cliente final do contratante", cliente: null,
    ...
    fluxo: ["TORG", "Cliente final do contratante"], cfops: ["5125", "6125", "5925", "6925", "5949", "6949"],
    ...
    notas: [
      { quem: "TORG", cfop: "5925/6925", papel: "Retorno simbólico ao contratante", de: "TORG", para: "Contratante", obs: "⚠ Só se as condições do art. 408 do RICMS/SP estiverem atendidas." },
      { quem: "TORG", cfop: "5125/6125", papel: "Industrialização", de: "TORG", para: "Contratante", obs: "O que a TORG cobra." },
      { quem: "TORG", cfop: "5949/6949", papel: "Remessa ao cliente final do contratante", de: "TORG", para: "Cliente final", obs: "⚠⚠ A que acompanha a carga. Não aplicar esta sistemática a qualquer triangulação." },
    ],
  },
