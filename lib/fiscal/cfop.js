...
export const OPERACOES = [
  ...
  { id: "indust-mp-cliente", titulo: "Industrialização com matéria-prima do cliente", cliente: "QWS",
    ...
    notas: [
      ...
      { quem: "Fornecedor", cfop: "5924/6924", papel: "Remessa física dos insumos à TORG", de: "Fornecedor", para: "TORG",
        natureza: "física", condicional: "o parágrafo único do art. 406 prevê hipótese de DISPENSA", fundamento: "RICMS/SP, art. 406, I — procedimento ordinário.",
  ...
  { id: "indust-entrega-direta", titulo: "Industrialização com entrega ao cliente final do contratante", cliente: null,
    ...
    notas: [
      ...
      { quem: "TORG", cfop: "5925/6925", papel: "Retorno simbólico ao contratante", de: "TORG", para: "Contratante",
        natureza: "simbólica", condicional: "as condições do art. 408 estarem atendidas", fundamento: "RICMS/SP, arts. 406 e 408.",
        cita: { norma: "RICMS-SP-art-404-405-406-407-408", rotulo: "Artigo 408" },
  ...
  { id: "dois-caminhoes", titulo: "Uma venda e dois caminhões", cliente: null,
    ...
    notas: [
      { quem: "TORG", cfop: "5922/6922", papel: "Simples faturamento", de: "TORG", para: "Cliente", condicional: "cenário de ENTREGA FUTURA", obs: "Só no cenário de ENTREGA FUTURA: fatura sem a mercadoria sair." },
      { quem: "TORG", cfop: "5116/6116", papel: "Saída física da entrega futura", de: "TORG", para: "Cliente", condicional: "cenário de ENTREGA FUTURA", obs: "Uma por carga, referenciando o faturamento." },
      { quem: "TORG", cfop: "5101/6101", papel: "Venda", de: "TORG", para: "Cliente", condicional: "cenário de REMESSA PARCIAL DE CONJUNTO", obs: "⚠ No outro cenário (remessa parcial de conjunto) o caminho é outro — os dois não se misturam." },
    ],
  },
