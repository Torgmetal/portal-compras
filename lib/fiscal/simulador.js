...
import { cenarioDaFamilia } from "@/lib/fiscal/cenarios";
...
function fichaDeEmissao({ escolha, ipi, pisCofins, icms }) {
  ...
  // ⚠ O cenário sai da FAMÍLIA do CFOP — mesmo critério que o PIS/COFINS e o ICMS já usam.
  const cenario = cfop ? cenarioDaFamilia(cfop.familia) : null;
