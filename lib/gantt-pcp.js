...
export async function lotesProgramados() {
  ...
  // nessas filas?" e, logo depois, "as linhas de sem bancadas precisamos listar essas OPs mesmo sem
  // datas programadas, pois aí que precisamos puxar elas". Vale para os CINCO setores com fila —
  // montagem, solda, acabamento, jato e pintura —, não só os três de baixo. O quadro só desenhava o
  // que já tinha dia e posto, então a faixa "sem bancada" nascia vazia e não dava para puxar nada
  // de dentro dele.
  //
