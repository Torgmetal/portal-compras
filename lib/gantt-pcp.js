...
export async function lotesProgramados() {
  ...
  // nessas filas?". Tinha — 156 peças no acabamento, 200 no jato, 246 na pintura — e o quadro
  // mostrava "sem programação" nos três, porque só desenhava o que já tinha dia e posto. A faixa
  // "sem bancada" existia e nascia vazia para sempre.
  //
