...
export const INDICADORES_ISO = [
  ...
  { id: "erros_projeto", processo: "ENGENHARIA", nome: "Erros de Projeto (RNC)",
    ...
    meta: { dir: "max", valor: 8, unidade: "RNCs" }, freq: "Mensal", fonte: "parcial", nota: "Contagem das RNCs de Engenharia/Projeto. A meta (≤8) é do ANO, medida no acumulado; o valor de cada mês é a contagem daquele mês. Para virar o % da ISO (≤1%) falta definir o denominador (o que conta como “projeto liberado”)." },
