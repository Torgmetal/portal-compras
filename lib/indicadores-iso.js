...
export const INDICADORES_ISO = [
  ...
  { id: "cumprimento_plano", processo: "PCP", nome: "Cumprimento do Plano de Produção",
    ...
    nota: "Meta de 90% definida em maio/2026 (mesma da planilha ISO) — não é provisória. Mede as liberações do Planejamento com dia marcado, a partir de ago/2026, quando o dia passou a existir. Peça concluída = corte concluído até o fim do dia programado; dia que ainda não fechou não entra na conta." },
