...
export const INDICADORES_ISO = [
  ...
  { id: "retrabalho_engenharia", processo: "ENGENHARIA", nome: "Retrabalho gerado pela Engenharia",
    oQueMede: "% do peso retrabalhado por erro de projeto sobre a produção do mês", comoSeMede: "(Peso das peças das RNCs de responsabilidade da Engenharia ÷ peso produzido/cortado no mês) × 100",
    // ⚠⚠ SÓ O QUE TEM RNC. Vitor (28/08/2026): "para os retrabalhos será em cima das RNCs que forem
    // geradas pela engenharia". Erro de projeto que volta da fábrica é não conformidade: sem RNC
    // aberta não há responsabilidade apurada, e o índice viraria opinião de quem preencheu a
    // planilha. Apontamento de chão de fábrica sem RNC fica fora — e o detalhamento diz quanto peso
    // isso deixa de fora, para o zero não ser lido como "não houve retrabalho".
    meta: { dir: "max", valor: 2, unidade: "%" }, freq: "Mensal", fonte: "parcial", nota: "Peso das peças das RNCs de responsabilidade da Engenharia ÷ peso cortado no mês. Só entra retrabalho com RNC aberta; apontamento do FORM 34 sem RNC fica fora. Depende de a RNC ter as peças escolhidas da Lista de Expedição — sem elas não há peso." },
