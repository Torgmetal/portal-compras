...
export const INDICADORES_ISO = [
  ...
  { id: "cumprimento_plano", processo: "PCP", nome: "Cumprimento do Plano de Produção",
    ...
    nota: "Mede as liberações do Planejamento com dia marcado (a partir de ago/2026, quando o dia passou a existir). Peça concluída = corte concluído até o fim do dia programado. Meta de 90% é a inicial — ajustar depois de dois ou três meses de série." },
