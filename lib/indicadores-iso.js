...
export const INDICADORES_ISO = [
  ...
  { id: "atendimento_competencias", processo: "RH", nome: "Atendimento das Competências",
    ...
    meta: { dir: "min", valor: 50, unidade: "%" }, freq: "Trimestral", fonte: "auto", nota: "Baseado nos documentos REAIS de cada colaborador (RH Documentos + regras por setor/CCT). Enche conforme o RH sobe os documentos; dispensados (PJ/Diretoria) ficam de fora." },
