...
export const INDICADORES_ISO = [
  ...
  { id: "rnc_cliente", processo: "QUALIDADE", nome: "Índice de RNCs Recebidas do Cliente",
    oQueMede: "Nº de RNCs pertinentes recebidas do cliente no período", comoSeMede: "Contagem de RNCs de cliente pertinentes no mês",
    meta: { dir: "max", valor: 8, unidade: "RNCs" }, freq: "Mensal", fonte: "auto" },
  ...
  { id: "atendimento_competencias", processo: "RH", nome: "Atendimento das Competências",
    oQueMede: "% de colaboradores com as competências da função atendidas", comoSeMede: "(Colaboradores CLT com todos os documentos obrigatórios do setor em dia ÷ colaboradores CLT) × 100",
    meta: { dir: "min", valor: 50, unidade: "%" }, freq: "Trimestral", fonte: "parcial", nota: "Documentos REAIS de cada colaborador (RH Documentos + regras/CCT); dispensados PJ/Diretoria e NRs dispensadas por função ficam de fora. Mês atual = foto de hoje; meses anteriores reconstruídos pela janela de validade de cada documento (para a média anual da auditoria)." },
