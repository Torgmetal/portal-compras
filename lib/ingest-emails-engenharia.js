...
// Remetentes IGNORADOS — e-mails automáticos do próprio portal (Workspace Torg /
// notificações), que não são correspondência de projeto. Configurável por env.
...
async function ingerirCaixaPasta(caixa, pasta, direcao, ignorados) {
  ...
  for (const m of mensagens) {
    ...
    if (from.endereco && ignorados.has(from.endereco)) continue; // e-mail automático do portal — ignora
