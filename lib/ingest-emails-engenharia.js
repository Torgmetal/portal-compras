...
const RX_REMETENTE_RUIDO = /@communication\.microsoft\.com$|@email\.teams\.microsoft\.com$|@microsoftonline\.com$|@sharepointonline\.com$|^(no-?reply|noreply|donotreply|do-not-reply|microsoft365|msonlineservicesteam)@/i;
