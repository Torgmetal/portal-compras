...
const RX_REMETENTE_RUIDO = /@communication\.microsoft\.com$|@email\.teams\.microsoft\.com$|@microsoftonline\.com$|@sharepointonline\.com$|@e\.read\.ai$|@read\.ai$|@fireflies\.ai$|@otter\.ai$|^trimble-noreply@|^suporte@construmanager\.com\.br$|^(no-?reply|noreply|donotreply|do-not-reply|microsoft365|msonlineservicesteam)@/i;
