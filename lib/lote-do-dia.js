...
// TRABALHO, não capacidade. Planejar pelo p90 é planejar por um dia bom que já aconteceu 6 vezes
// em 57; a mediana planeja pelo dia médio, que é o dia em que faltou serviço.
export const POOLS = {
  PERFIS: { label: "Perfis", kgDia: 6110, pecasDia: 452 },
  CHAPAS: { label: "Chapas", kgDia: 3109, pecasDia: 1135 },
};
/** o que a casa já fez no melhor dia — o teto físico observado, para comparar */
export const POOLS_MAXIMO = {
