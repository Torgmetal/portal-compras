...
/** A consulta usa a mesma área por cor/destino do cálculo de consumo.
 * A área histórica importada não substitui a distribuição atual do Quantitativo.
 * O preço fechado do grupo continua sendo tratado separadamente por calcularLqc.
 */
export function calcularCamadasPinturaConsulta(c) {
  return calcularCamadasPintura(c);
}
