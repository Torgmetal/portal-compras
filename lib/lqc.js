...
export function calcularLqc(c = {}) {
  ...
  return {
    ...
    porArea: (() => {
      ...
      // ⚠ frete só rateia quando é DILUÍDO. Separado, ele é linha própria da proposta e entrar no
      // R$/kg da área o cobraria duas vezes.
      ...
      return [...mapa.values()].map((g) => {
        ...
        const industrializacao = r2(g.fabricacao + g.pintura + g.preMont);
    ...
    areaM2: r2(areaM2), ensaios, frete, cargas, preMontagemPct: pctPre, pinturaPorArea,
