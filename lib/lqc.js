...
export function decisaoTerceirizar({
  cadencia = {}, custoOperacionalMes = 0, precoTerceiroKg = 0, freteKg = 0, retrabalhoPct = 0, margemPorMes = 0,
} = {}) {
  const casaMes = n(custoOperacionalMes);
  const foraKg = r2(n(precoTerceiroKg) + n(freteKg));
