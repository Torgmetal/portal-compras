...
/* ⚠⚠ A LISTA NÃO ESCREVE POR EXTENSO. Vitor (08/09/2026), sobre a OP-094: "a programação ainda está
   ...
   ⚠ O QUE NÃO ESTÁ AQUI É DE PROPÓSITO. `FRØ` (ferro redondo, 4.906 peças), `BRØ` (barra redonda)
   e `FC` (ferro chato) ficaram fora até alguém dizer em que máquina se cortam — o comentário do
...
export const MAQUINAS = [
  ...
  { id: "LASER_TUBO", nome: "Laser Tubo", rx: /\b(tubo|tb\s?\d|metalon|quadrad|redond(o|a)\s|din\s?2440)/i },
