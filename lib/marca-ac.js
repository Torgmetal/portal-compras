...
export function marcaEhAC(marca) {
  ...
  // positivo em marcas que só por acaso tenham "AC" no meio). O hífen antes do AC é
  // opcional: a LE da OP-089 grava "T89-AC1" (parafusos, porcas, cola) — sem ele, esses
  // 34 itens passavam por peça e apareciam na tela do inspetor (14/09/2026).
