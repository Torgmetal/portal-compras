...
export const MATRIZ_COMUNICACAO = [
  {
    ...
    pessoas: [
      { nome: "Matheus Lima", foto: "/equipe/matheus-lima.jpg", cargo: "Comercial", email: "matheus.lima@torg.com.br", tel: "(19) 99410-7082", backup: "Patricia Maiochi",
        escopo: ["Estudo e escopo do projeto", "Itens inclusos / exclusos", "Elaboração de proposta", "Negociação de contratos"] },
      { nome: "Patricia Maiochi", foto: "/equipe/patricia.jpg", cargo: "Comercial", email: "comercial@torg.com.br", tel: "(19) 99248-2076", backup: "Matheus Lima",
  ...
  },
  {
    ...
    responsabilidades: [],
    pessoas: [
      { nome: "Matheus Martha", foto: "/equipe/matheus-martha.jpg", cargo: "Compras", email: "matheus.martha@torg.com.br", tel: "(19) 99852-2099", backup: "Patricia Maiochi (Comercial)",
  ...
  },
  {
    ...
    pessoas: [
      { nome: "Guilherme Campos", foto: "/equipe/guilherme.jpg", cargo: "Diretor Técnico", email: "guilherme@torg.com.br", tel: "(19) 99774-6292", backup: "Diego Dias",
        escopo: ["Cálculos", "Detalhes técnicos"] },
      { nome: "Diego Dias", foto: "/equipe/diego.jpg", cargo: "Coordenador de Engenharia", email: "engenharia@torg.com.br", tel: "(19) 99418-4382", backup: "John Cornia (engenharia4@torg.com.br)",
  ...
  },
  {
    ...
    pessoas: [
      { nome: "Larissa Mantovani", foto: "/equipe/larissa.jpg", cargo: "Planejamento", email: "pcp@torg.com.br", tel: "(19) 2023-0207", backup: "Geraldo Tank",
  ...
  },
  {
    ...
    pessoas: [
      { nome: "Fabrine Susigan", foto: "/equipe/fabrine.jpg", cargo: "Gestora de Contrato", email: "fabrine@torg.com.br", tel: "(19) 97105-8769", backup: "Gabriel Rodrigues",
        escopo: ["Alinhamento e programação de frentes de trabalho"] },
      { nome: "Gabriel Rodrigues", foto: "/equipe/gabriel.jpg", cargo: "Programador de Produção", email: "engenharia3@torg.com.br", tel: "(19) 2023-0207", backup: "Fabrine Susigan",
  ...
  },
  {
    ...
    pessoas: [
      { nome: "Geraldo Tank", foto: "/equipe/geraldo.jpg", cargo: "Qualidade", email: "qualidade@torg.com.br", tel: "(11) 96413-7308", backup: "Fabrine Susigan",
