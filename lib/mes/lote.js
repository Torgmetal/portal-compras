...
import { comTravaDoRecurso } from "@/lib/mes/trava";
 ...
 */
export async function abrirLote(prisma, { recursoId, operadorId = null, trabalhos = [], ambiente = "PROD", loteId = null, nestingUnidadeId = null }) {
 ...
 */
export async function encerrarLote(prisma, { recursoId, loteId, operadorId = null }) {
