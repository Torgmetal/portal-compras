 ...
 *
 * ⚠ `opId` continua servindo de identidade quando não há número (abertura só por id).
 */
const daObra = (s) => (s.opNumero ? { opNumero: s.opNumero } : { opId: s.opId });
 ...
 *
 * ⚠ Sai de `daObra`, e não de uma expressão paralela: foi a expressão paralela que divergiu.
 */
