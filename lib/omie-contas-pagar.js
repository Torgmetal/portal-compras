 ...
 */
export async function sincronizarContasPagar({ incremental = true, maxDetalhe = 120 } = {}) {
  ...
  // Enriquece detalhe das ABERTAS sem detalhe ainda (limitado por maxDetalhe)
  ...
  return { sincronizados: ids.length, detalhados: aEnriquecer.length, total };
}
