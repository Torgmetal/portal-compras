 ...
 *
 * ⚠⚠ DECISÃO DO VITOR (26/09/2026): *"o material de terceiro sim é da Torg e pode ser usado"*. Entram o
 * Almoxarifado (consumíveis; é o padrão), a Fábrica (aço) e o "ESTOQUE TERCEIRO" — 273 itens, 1,43 milhão,
 * a maior parte aço, sem movimento desde fev/2025. Com ele, o que entrou no Terceiro e foi baixado na
 * Fábrica fecha a conta (W610×174: −5.112,6 + 126.606,4); sem ele, 8 produtos saíam negativos.
 * Ficam fora os de PATRIMÔNIO (máquinas e equipamentos, ferramentas, edificações): não são material
 * de uso — hoje só 11 luvas estão lá. ⚠ Local NOVO não entra sozinho: aparece no detalhe e espera
 * alguém decidir aqui.
 */
export const LOCAIS_NA_QTD = new Set([
  "7315778267", // 001 ESTOQUE ALMOXARIFADO (padrão)
  "7320665233", // 002 ESTOQUE FABRICA
  "7572486140", // 003 ESTOQUE TERCEIRO
]);
