...
// ⚠ Prazo da leitura de locais + posição quando quem chama não passa o seu: cabe no `maxDuration`
// de 60 s das rotas, com folga para gravar e bater o ponto do monitor.
const PRAZO_POSICAO_MS = 40_000;
