...
export async function consultarPedidoVenda({ numeroPedido, codigoPedido } = {}) {
  ...
  try {
    ...
    // valorBruto = valor TOTAL do pedido. Pro cenario tipico (cada medicao
    // parcial criada como pedido separado no Omie — ex: 233/1, 233/2), o
    // total do pedido JA EH o valor da medicao.
    //
    // Pra auditoria, calcula tambem valorFaturadoAuto das parcelas — util
    // pra rastreio mas nao usado como default.
