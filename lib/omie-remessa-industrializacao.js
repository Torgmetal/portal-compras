...
export function configRemessa() {
  ...
  return { ok: Boolean(cenario), cenario, categoria, cfopForcado, valorKg, cstIcms, cstPisCofins, cstIpi, origem };
}
...
function impostosRemessa(cfg) {
  return {
    ...
    IPI: { cSitTribIPI: cfg.cstIpi, cEnqIPI: "999", nBCIPI: 0, nAliqIPI: 0, nValIPI: 0 },
