...
export const ABAS_OP = ["resumo", "obra", "engenharia", "planejamento", "compras", "producao", "terceiros", "expedicao", "financeiro"];

/** O que o portal mostrava a quem não vê dinheiro. É o piso de quem não está no mapa. */
const OPERACIONAL = ["obra", "engenharia", "planejamento", "compras", "producao", "terceiros", "expedicao"];
