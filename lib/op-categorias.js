...
export const CATEGORIAS_MATERIAL = [
  ...
  { codigo: "CALCULO_ESTRUTURAL",   label: "Cálculo Estrutural",   tipo: "VERBA",     unidade: null },
  { codigo: "PROJETO_TERCEIRIZADO", label: "Projeto Terceirizado", tipo: "VERBA",     unidade: null },
  { codigo: "DOBRA",                label: "Dobra",                tipo: "VERBA",     unidade: null },
  { codigo: "CALANDRAGEM",          label: "Calandragem",          tipo: "VERBA",     unidade: null },
  { codigo: "FRETES_ENTREGA",       label: "Fretes de Entrega",    tipo: "VERBA",     unidade: null },
];
