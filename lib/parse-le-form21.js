...
export function parseFormularioLE(buffer, { opNumeroForcado = null, sheetName = null } = {}) {
  ...
  for (let i = dataStart; i < rows.length; i++) {
    ...
    // Pula a linha de TOTAL da planilha (marca "TOTAL.:", "TOTAL GERAL"…). Ela vinha
    // entrando como peça e DOBRAVA o peso da OP: o qtd dela é a soma geral (não 0), então
    // o skip por qtd===0 abaixo não pegava. Ex.: OP-071 dava 18.664 = 9.332 real + TOTAL 9.332.
    if (normalize(marca).startsWith("total")) continue;
