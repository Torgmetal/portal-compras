...
// Aceita ArrayBuffer / Uint8Array / Buffer — roda no navegador (parse client-side,
// evita subir o .xls de vários MB) e no servidor.
export function parseRncForm20(input) {
