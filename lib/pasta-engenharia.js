...
export async function inventarioEngenharia(opNumero) {
  ...
  if (!base) return { achou: false, erro: "Pasta da OP não encontrada no SharePoint.", pdfs: [], pdfsEnvio: [], outrosPdfs: 0, nc1: [], igs: [], listas: [], cliente: [], modelos: 0, ultimo: null };
...
// O que a pasta de envio faz aqui é explicar o motivo — marca com `soEnvio` foi desenhada e está no
// lugar errado, o que se resolve movendo, não desenhando.
