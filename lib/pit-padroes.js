...
export const PIT_PADROES = [
  {
    id: "PINTURA", nome: "Pintura líquida", snqc: false,
...
export const PIT_COLUNAS = {
  comum: ["ITEM", "ESCOPO DE INSPEÇÃO", "TIPO DE INSPEÇÃO", "% TORG", "% CLIENTE", "CRITÉRIO DE ACEITAÇÃO", "EVIDÊNCIAS / REGISTROS", "NOTAS"],
  snqc: ["ITEM", "ESTRUTURA METÁLICA", "TIPO DE INSPEÇÃO (PONTOS DE ESPERA)", "RESPONSÁVEL PELA INSPEÇÃO", "PERCENTUAL AVALIADO", "EVIDÊNCIAS / REGISTRO", "CRITÉRIO DE ACEITAÇÃO", "NOTAS"],
};
