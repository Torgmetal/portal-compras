...
export async function gerarPlanoAcaoPDF(p) {
  ...
  // ⚠ o nome segue o SGQ (FORM 28), sem o slug do título: é assim que os formulários preenchidos
  // já estão nomeados no SharePoint, e o número PA-nnn sozinho já identifica o plano.
  return { bytes, filename: nomeFORM(28, numPA(p.numero)) };
}
