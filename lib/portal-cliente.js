...
export const TIPOS_ENGENHARIA = [
  ...
  //
  // ⚠ SÓ A PASTA DO CONJUNTO (2.5.2.3), não a 2.5.2 inteira. A 2.5.2 guarda também o CROQUI
  // (2.5.2.2) — a peça solta que a fábrica corta —, e croqui não é projeto de fabricação para quem
  // recebe a obra: são centenas de folhas de sub-peça que só confundem quem procura o conjunto.
  //
  // ⚠ PDF E DWG, e nada mais. A pasta tem arquivo de trabalho do Tekla junto; sem a lista de
  // extensões o cliente veria .db1, .skp e o que mais estiver lá.
  {
    id: "FABRICACAO", nome: "Projetos de fabricação",
    resumo: "Os desenhos dos conjuntos da obra, em PDF e DWG.",
    onde: "2.5.2 Fabricação › 2.5.2.3 Conjunto",
    pastas: [["2", "2.5", "2.5.2", "2.5.2.3"]],
    extensoes: ["pdf", "dwg"],
  },
];
