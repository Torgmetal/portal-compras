...
export function pecasPendentesNoSetor(pecas, realSetorByMarca, setorKey) {
  const map = realSetorByMarca || new Map();
...
// Data de entrega do SETOR para uma OP: usa datasSetor[setorKey] (Solicitação de
// Produção, "YYYY-MM-DD"); na falta, cai pra entrega final da OP (entregaFallback).
