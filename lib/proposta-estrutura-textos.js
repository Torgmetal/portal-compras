...
export const TEXTOS = {
  ...
  // ⚠⚠ O CRONOGRAMA VIRA SEÇÃO DA PROPOSTA, não anexo colorido. Vitor (05/09/2026), sobre a prova
  // em PDF no estilo do portal: "não bem assim que eu queria mostrar para o cliente, pois não tem
  // nada a haver com o estilo da nossa proposta". O item "Prazo de execução" já existe no modelo;
  // o que faltava era o quadro por etapa e a régua de entregas embaixo dele, na fonte do documento.
  //
  // ⚠ as linhas não repetem o que a tabela diz. Elas dizem o que a tabela NÃO consegue: que as
  // etapas se sobrepõem, de onde conta o prazo e que a entrega é parcial.
  CRONOGRAMA: {
    titulo: "Cronograma preliminar de fornecimento",
    ancora: ["PRAZO", "CONTROLE_QUALIDADE", "PLANILHA_PRECO"],
    linhas: [
      "O cronograma abaixo é preliminar e foi elaborado a partir do quantitativo desta proposta ({pesoTotal} kg) e do desempenho médio da TORG em obras de porte equivalente.",
      "As etapas se sobrepõem: a aquisição da matéria-prima é iniciada com o detalhamento em andamento, e a fabricação começa após a chegada do aço e a liberação dos desenhos. Por isso o prazo total é menor que a soma das etapas.",
      "O prazo conta a partir da assinatura do contrato e da liberação, pela CONTRATANTE, do projeto básico e da documentação técnica relacionada nesta proposta.",
      "O fornecimento é entregue em cargas parciais, acompanhando a fabricação, conforme o quadro de entregas.",
    ],
    tabela: "cronograma",
  },
