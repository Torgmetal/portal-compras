...
export const TIPOS_RELATORIO = [
  { id: "DIMENSIONAL", label: "Inspeção dimensional", secao: "11", sigla: "RID" },
  { id: "VISUAL_SOLDA", label: "Ensaio visual de solda", secao: "12", sigla: "REVS" },
  { id: "LP", label: "Líquido penetrante", secao: "12", sigla: "RLP" },
  { id: "PINTURA", label: "Pintura / tratamento", secao: "14", sigla: "RIP" },
  { id: "MONTAGEM", label: "Montagem", secao: null, sigla: "RIM" },
