...
export const TIPOS_RELATORIO = [
  { id: "DIMENSIONAL", label: "Inspeção dimensional", secao: "11" },
  { id: "VISUAL_SOLDA", label: "Ensaio visual de solda", secao: "12" },
  { id: "LP", label: "Líquido penetrante", secao: "12" },
  { id: "PINTURA", label: "Pintura / tratamento", secao: "14" },
  { id: "MONTAGEM", label: "Montagem", secao: null },
  { id: "GERAL", label: "Registro geral", secao: null },
];
