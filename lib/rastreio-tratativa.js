...
//   RECEBIMENTO (informa)       pedido, data e OP. Diz de qual compra o material veio. Falta
...
//
// ⚠ A NF NÃO É COBRADA. Vitor (24/09/2026): "vamos tirar essa regra de ter a NF informada, pois
// principalmente esses da Aços Maq acaba sendo um problema". Material de faturamento direto (o
// pedido 1719 da AÇOS MAQ, chapa da OP-102) sai com nota para o CLIENTE — a Torg não tem NF de
// entrada dele, e a lacuna "falta NF" ficava acesa para sempre sobre material que chegou e está em
// dia. Quem prova a origem do aço é o certificado e a corrida; a NF, quando houver, continua gravada
// e à vista.
...
export function conferir(doc, { temArquivo, achavel = false, tratativa = null, origemTemCertificado = false }) {
  ...
  // ⚠ sem "nf": ver A NF NÃO É COBRADA, no topo
  const lacunas = [];
...
export const ROTULO_LACUNA = { pedido: "pedido", data: "data de recebimento", op: "OP" };
