...
export const REGRAS_DOCUMENTOS = [
  ...
  },
  {
    ...
    cargos: ["pintor"], // pintores lidam com tintas/solventes inflamáveis
    validadeMeses: 24, // reciclagem (classe intermediária) — ajustar se a operação exigir outra
    descricao: "Obrigatório para quem trabalha com inflamáveis/combustíveis — pintores (tintas e solventes). Reciclagem periódica.",
    referenciaCCT: "NR-20 — Segurança e Saúde no Trabalho com Inflamáveis e Combustíveis",
    dispensavel: true, // o RH pode dispensar por funcionário dentro do cargo
  },
