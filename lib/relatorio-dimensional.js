...
export async function baixarDesenho(caminho) {
  ...
  // ⚠ PROJETO ANEXADO À MÃO vem como URL do blob, não como caminho do servidor. É o caso do
  // diagrama de montagem na pré-montagem: ele não tem marca de peça e nem sempre está na pasta de
  // projetos, então o inspetor anexa. Aceitar os dois aqui evita um segundo caminho de leitura.
