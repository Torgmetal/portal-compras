 ...
 */
export function novaFolha({ pdf, font, bold, logo }) {
  ...
  const f = {
    ...
    cabecalho({ titulo, codigo, emitidoEm, folha = 1, total = 1 }) {
      ...
      page.drawText(san(titulo), { x: M + 82, y: f.y - 20, size: 11, font: bold, color: NAVY });
      page.drawText("Torg Metal · Sistema de Gestão da Qualidade · ISO 9001", { x: M + 82, y: f.y - 33, size: 7, font, color: GRAY });
