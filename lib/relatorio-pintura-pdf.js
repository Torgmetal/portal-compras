...
export async function gerarPinturaPDF({ rel, fotos = [], assinaturas = null, cliente = null, obra = null, refCliente = null }) {
  ...
  f.cabecalho({ titulo: "RELATÓRIO DE INSPEÇÃO DE PINTURA", codigo: rel.codigo, emitidoEm: rel.emitidoEm, folha: 1, total: 2 });
  ...
  f2.cabecalho({ titulo: "RELATÓRIO DE INSPEÇÃO DE PINTURA", codigo: rel.codigo, emitidoEm: rel.emitidoEm, folha: 2, total: 2 });
