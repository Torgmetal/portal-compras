...
import { anexarRevisaoNoDataBook, vincularNoDataBook } from "@/lib/relatorio-inspecao";
...
export async function abrirRevisaoRelatorio(relatorioId, { motivo = "", porQuem = "", porQuemId = null, origem = "PORTAL" } = {}) {
  ...
  // ⚠ o relatório voltou a rascunho: sai do data book até a nova rodada ser assinada por todos
  await vincularNoDataBook(relatorio, null).catch(() => {});
