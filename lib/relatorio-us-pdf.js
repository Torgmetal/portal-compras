...
export async function gerarUSPDF({ rel, assinaturas = null, cliente = null, obra = null, refCliente = null }) {
  ...
  for (let p = 0; p < paginas; p++) {
    ...
    if (p === paginas - 1) {
      ...
      f.blocoAssinaturas(assinaturas, ["Inspetor", "Controle de Qualidade", "Cliente"]);
    }
  }
