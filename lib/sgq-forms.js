...
export const FORMS = {
  // ⚠ O FORM 09 ENTROU EM 31/08/2026, e a razão é a que estava escrita aqui como motivo para
  // ficar de fora: "a guia real é uma remessa numerada e o portal não a emite". Agora emite —
  // Vitor pediu a guia do PCP, com número próprio, e é ela que prova numa auditoria o que foi
  // entregue a qual setor. O que continua de fora é o Excel de CONTROLE das liberações, que é
  // relatório gerencial e não a guia.
  // ⚠ O FORM 08 ENTROU EM 10/09/2026: o portal passou a emitir a Análise Crítica de Projeto (PO-13)
  // a partir do registro na aba Engenharia da OP — o modelo antigo (R1, .doc) era uma folha de "X".
  8: { nome: "Análise Crítica dos Requisitos Relacionados ao Produto", revModelo: "01", rev: "02" },
  9: { nome: "Guia de Remessa de Documentos (GRD)", revModelo: "00", rev: "01" },
  // FORM 10 ENTROU EM 11/09/2026: a ata da reunião de análise crítica sai do registro da OP (bloco 7)
  10: { nome: "Ata de Reunião da Análise Crítica do Projeto e Desenvolvimento", revModelo: "01", rev: "02" },
