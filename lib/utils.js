 ...
 * O prefixo T dos cronogramas é interno: "T121" → "OP-121", sem alterar o cadastro.
 *
 ...
 */
export const fmtOP = (numero) => (numero ? `OP-${String(numero).trim().replace(/^T(?=\d)/i, "").padStart(3, "0")}` : "—");
