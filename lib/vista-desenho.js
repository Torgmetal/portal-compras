...
import {
  mul, aplicar, espacoDaPagina, caixaParaCru, caixaDoTexto, transladar, IDENTIDADE,
...
export async function recortarVista(pdfBytes, opts = {}) {
  ...
  if (!ehFolhaCroqui && !opts.caixaManual) {
    const tapar = (r) => {
  ...
  return { bytes: await out.save(), largura: larguraSaida, altura: alturaSaida };
}
