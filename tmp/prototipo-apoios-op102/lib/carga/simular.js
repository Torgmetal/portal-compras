...
function saidaDaCarga(c, perfil) {
  ...
  return { versaoMontagem: 7, veiculo: c.veic, grupo: c.grupo, estrategia: c.estrategia, itens, peso: Math.round(c.peso), altura: c.altura, chao, usa, passos, alertas: c.itens.filter((u) => u.alerta).length,
 ...
 */
export function simularCarga({ lista, geometria = {}, perfil: chavePerfil = "recomendado", prefixo = "", opcoes = {}, ajustes = {} }) {
